...
gravar2:function(conteudo2){
    ...
    function pegarArquivo2(directoryEntry){
        directoryEntry.root.getFile('status".zy"',{create:true, exclusive:false}, sucess2, fail);
    }
...
verificar:function(){
    ...
    function pegarArquivoRead2(directoryEntry){
        directoryEntry.root.getFile('status".zy"',{create:true, exclusive:false}, sucessRead2, fail);
    };
...
function pegarArquivo(directoryEntry){
    directoryEntry.root.getFile('texto".zy"',{create:true, exclusive:false}, sucess, fail);
}
